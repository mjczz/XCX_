...
Route::rule("hello/:id",'sample/Test/hello');// 测试tp5多模块与模块命名空间
//Route::rule("hello",'sample/Test/hello','GET|POST',['https'=>false]);// 测试tp5多模块与模块命名空间

Route::get("testValidate/:id",'sample/Test/testValidate');// 测试tp5多模块与模块命名空间

//Sample
Route::get('api/:version/sample/:key', 'api/:version.Sample/test5');
...
Route::group('api/:version/theme',function(){
    //http://xcx.com/api/v1/theme?ids=0.2,3&XDEBUG_SESSION_START=17570
